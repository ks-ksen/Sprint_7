...
public class Order {
    ...
    public Order(String тест, String тестов, String address, String сокольники, String phone, int rentTime, String date, String тестовыйКомментарий, List<String> colors) {
    }
